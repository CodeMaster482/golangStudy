...
func main() {
	...
	money := []ds.Banknote{
		...
		{Nominal: 100, ImageURL: "http://127.0.0.1:9000/banknote-name-server/7a5e6e87-316c-40cd-8123-ac716ac019fb.jpg", Currency: "RUB", Status: "действует"},
		...
		{Nominal: 100, ImageURL: "http://127.0.0.1:9000/banknote-name-server/d21aa751-2e31-446a-986b-53a1c149e894.jpg", Currency: "USD", Status: "действует"},
	}
